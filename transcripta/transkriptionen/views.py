...
from transcripta.upload.models import Institution, RefNumber, DocumentTitle
...
class InstitutionListView(ListView):
    ...
    template_name = "transkriptionen/institutionlist.html"
...
class InstitutionDetailView(DetailView):
    ...
    template_name = "transkriptionen/institutiondetail.html"
...
class RefNumberDetailView(DetailView):
    model = RefNumber
    template_name = "transkriptionen/refnumberdetail.html"
...
class DocumentTitleDetailView(DetailView):
    model = DocumentTitle
    template_name = "transkriptionen/documenttitledetail.html"
