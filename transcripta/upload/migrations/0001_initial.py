# Generated by Django 3.0.4 on 2020-05-13 14:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child_type', to='upload.SourceType', verbose_name='übergeordnete Archivalienart')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holding_institution', models.ForeignKey(help_text='Institution, welche die Signatur beherbergt', on_delete=django.db.models.deletion.PROTECT, related_name='refnumbers', to='upload.Institution', verbose_name='institution')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(blank=True, help_text='Autor*innen, Kopist*innen, Editor*innen', to='upload.Author', verbose_name='beteiligte Personen')),
                ('language', models.ManyToManyField(blank=True, help_text='In der Quelle verwendete Sprachen', to='upload.SourceLanguage', verbose_name='sprachen')),
                ('parent_institution', models.ForeignKey(help_text='Institution, welche die Quelle aufbewahrt', on_delete=django.db.models.deletion.PROTECT, related_name='documents', to='upload.Institution', verbose_name='institution')),
                ('parent_refnumber', models.ForeignKey(help_text='Signatur der Quelle', on_delete=django.db.models.deletion.PROTECT, related_name='documents', to='upload.RefNumber', verbose_name='signatur')),
                ('source_type', models.ForeignKey(blank=True, help_text='Archivalienart/Quellengattung', null=True, on_delete=django.db.models.deletion.PROTECT, to='upload.SourceType', verbose_name='archivalienart')),
            ],
            options={
