        ...
        if not force_update:
            ...
            if trigger_notifications:
                ...
                for d_sub in doc_subscriptions:
                    ...
                    notification = UserNotification.objects.create(subscription=d_sub, user=d_sub.user,
                    ...
                    if d_sub.user.notification_policy == User.NotificationPolicy.IMMEDIATE.value:
                        send_instant_notification_mail(d_sub.user, notification)
                        # TODO Test instant mail sending
                ...
                for r_sub in ref_subscriptions:
                    ...
                    notification = UserNotification.objects.create(subscription=r_sub, user=r_sub.user,
                    ...
                    if r_sub.user.notification_policy == User.NotificationPolicy.IMMEDIATE.value:
                        send_instant_notification_mail(r_sub.user, notification)
                        # TODO Test instant mail sending
                ...
                for u_sub in usr_subscriptions:
                    if self.publish_user:
                        notification = UserNotification.objects.create(subscription=u_sub, user=u_sub.user,
                        ...
                        if u_sub.user.notification_policy == User.NotificationPolicy.IMMEDIATE.value:
                            send_instant_notification_mail(u_sub.user, notification)
                            # TODO Test instant mail sending
