    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_policy', models.IntegerField(choices=[(1, 'No notification Emails'), (2, 'Every time a subscribed document has changed.'), (3, 'Once a day, only if changes happened.'), (4, 'Once a week, only if changes happened.')], default=3, help_text='How often do you want to be notified about your subscribed documents?', verbose_name='Subscription Notification policy')),
                ('message_notification_policy', models.IntegerField(choices=[(1, 'No notification Emails'), (2, 'Every time a message is sent.'), (3, 'Once a day, only if you received messages.')], default=2, help_text='How often do you want to be notified about messages you receive?', verbose_name='Message Notification policy')),
