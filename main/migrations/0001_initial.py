# Generated by Django 3.2 on 2021-04-06 12:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(help_text='Street', max_length=80, verbose_name='street')),
                ...
                ('site_url', models.URLField(blank=True, help_text='URL of the Website', verbose_name='website')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_name', models.CharField(max_length=50, verbose_name='Language')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ManyToManyField(blank=True, help_text='In der Quelle verwendete Sprachen', to='main.SourceLanguage', verbose_name='sprachen')),
                ...
                ('parent_refnumber', models.ForeignKey(help_text='Signatur der Quelle', on_delete=django.db.models.deletion.PROTECT, related_name='documents', to='main.refnumber', verbose_name='signatur')),
